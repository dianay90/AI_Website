...
document.addEventListener('DOMContentLoaded', table)// JavaScript source code
...
function style() {
    document.getElementById("imgs4").style.textAlign = "center";
    document.getElementById("imgs4.0").style.textAlign = "center";
    document.getElementById("headers2").style.textAlign = "center";


    document.getElementById("headers2").style.fontFamily = "Garamond";
    document.getElementById("headers2").style.fontSize = "xx-large";
    document.getElementById("headers2").style.textAlign = "center";
